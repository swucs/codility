 ...
 *
 * J ≠ K와 J 번째 및 K 번째 디스크에 최소한 하나의 공통점이 있으면 J 번째 디스크와
 * K 번째 디스크가 교차한다고 말합니다(디스크에 경계가 포함되어 있다고 가정).
 *
 ...
 *
 * 위에서 설명한 N개의 디스크를 설명하는 배열 A가 주어지면 교차하는 디스크의 (순서 없는) 쌍의 수를 반환합니다.
 * 함수는 교차 쌍의 수가 10,000,000을 초과하면 -1을 반환해야 합니다.
 *
