 ...
 *
 * 물고기 번호 P는 A[P]와 B[P]로 표시됩니다. 배열 A는 물고기의 크기를 포함합니다. 모든 요소는 독특합니다. 배열 B는 물고기의 방향을 포함합니다. 여기에는 0 및/또는 1만 포함됩니다. 여기서:
 *
 * 0은 상류로 흐르는 물고기를 나타내고,
 * 1은 하류로 흐르는 물고기를 나타낸다.
 * 두 물고기가 반대 방향으로 움직이고 그 사이에 다른 (살아 있는) 물고기가 없으면 결국 서로 만날 것입니다. 그러면 한 마리의 물고기만 살아남을 수 있습니다. 큰 물고기가 작은 물고기를 잡아먹습니다. 보다 정확하게는 P < Q, B[P] = 1 및 B[Q] = 0일 때 두 물고기 P와 Q가 서로 만나고, 그들 사이에 살아있는 물고기가 없다고 말합니다. 그들이 만난 후:
 *
 ...
 *   A[3] = 1 B[3] = 0
 *   A[4] = 5 B[4] = 0
 * 처음에는 모든 물고기가 살아 있고 1번 물고기를 제외한 모든 물고기가 상류로 이동하고 있습니다. 1번 물고기가 2번 물고기를 만나서 먹고, 3번 물고기를 만나 자기도 먹습니다. 마지막으로 물고기 4번을 만나 먹습니다. 나머지 두 물고기(0번과 4번)는 만나지 않고 따라서 살아남습니다.
 *
 * 함수 작성:
 *
